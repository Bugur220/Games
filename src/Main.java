...
public class Main {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        File folderSrc = new File("C:\\Users\\miron\\Games\\src");
        if(folderSrc.mkdir()){
        ...
        File folderRes = new File("C:\\Users\\miron\\Games\\res");
        if(folderRes.mkdir()) {
            sb.append("Поддиректория ")
        ...
        File folderSaveGames = new File("C:\\Users\\miron\\Games\\savegames");
        ...
        File folderTemp = new File("C:\\Users\\miron\\Games\\temp");
        if(folderTemp.mkdir()) {
            sb.append("Поддиректория ")
        ...
        File folderMain = new File("C:\\Users\\miron\\Games\\src\\main");
        if(folderMain.mkdir()) {
            sb.append("Поддиректория ")
        ...
        File folderTest = new File("C:\\Users\\miron\\Games\\src\\test");
        if(folderTest.mkdir()) {
            sb.append("Поддиректория ")
        ...
        File fileMain = new File("C:\\Users\\miron\\Games\\src\\main\\Main.java");
        try {
        ...
        File fileUtils = new File("C:\\Users\\miron\\Games\\src\\main\\Utils.java");
        try {
        ...
        File folderDrawables = new File("C:\\Users\\miron\\Games\\res\\drawables");
        ...
        File folderVectors = new File("C:\\Users\\miron\\Games\\res\\vectors");
        ...
        File folderIcons = new File("C:\\Users\\miron\\Games\\res\\icons");
        ...
        File fileTemp = new File("C:\\Users\\miron\\Games\\temp\\temp.txt");
        try {
        ...
        try(FileWriter fw = new FileWriter("C:\\Users\\miron\\Games\\temp\\temp.txt")) {
        ...
        saveGame("C:\\Users\\miron\\Games\\savegames\\save1.dat", gameProgressInst1);
        saveGame("C:\\Users\\miron\\Games\\savegames\\save2.dat", gameProgressInst2);
        saveGame("C:\\Users\\miron\\Games\\savegames\\save3.dat", gameProgressInst3);

        List<String> paths = new ArrayList<>();
        paths.add("C:\\Users\\miron\\Games\\savegames\\save1.dat");
        paths.add("C:\\Users\\miron\\Games\\savegames\\save2.dat");
        paths.add("C:\\Users\\miron\\Games\\savegames\\save3.dat");

        zipFiles("C:\\Users\\miron\\Games\\savegames\\save.zip", paths);
        deleteUnpackingFiles();

        // Задание 3
        zipUnpacking("C:\\Users\\miron\\Games\\savegames\\save.zip",
                "C:\\Users\\miron\\Games\\savegames");
        System.out.println(openProgress("C:\\Users\\miron\\Games\\savegames\\packed_save1.dat"));
    }
}